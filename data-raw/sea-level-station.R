...
sea_level_station$Station %<>% str_replace("^Prince_Rupert$", "Prince Rupert") %>% factor()
...
warning("Get Lat and Long for sea level cities")
sea_level_station$Latitude <- NA_real_
sea_level_station$Longitude <- NA_real_
