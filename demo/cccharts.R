...
trend_pngs(data = cccharts::flow_station_discharge, facet = c("Term", "Statistic"), width = 500L, ask = FALSE)
trend_pngs(data = cccharts::flow_station_timing, facet = c("Term", "Statistic"), width = 500L, ask = FALSE)
