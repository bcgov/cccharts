...
plot_estimates_pngs(data = cccharts::precipitation, x = "Ecoprovince", facet = "Season", width = 500L, ask = FALSE)
plot_estimates_pngs(data = cccharts::sea_level_station, x = "Station", by = c("Indicator", "Statistic", "Season"), ask = FALSE)
plot_estimates_pngs(data = cccharts::sea_surface_temperature_station, x = "Station", c("Indicator", "Statistic", "Season"), ask = FALSE)
plot_estimates_pngs(data = cccharts::snow, ask = FALSE)
plot_estimates_pngs(data = cccharts::snow_station, x = "Station", by = c("Indicator"), ask = FALSE)
