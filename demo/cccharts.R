...
trend_pngs(data = cccharts::flow_station_discharge, facet = c("Statistic", "Term"), width = 500L, ask = FALSE)
trend_pngs(data = cccharts::flow_station_timing, x = "Station", by = "Statistic", facet = "Term", width = 500L, ask = FALSE)
