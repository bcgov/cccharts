...
map_estimates_pngs(data = cccharts::snow, by = "Indicator", ask = FALSE)
map_estimates_pngs(data = cccharts::snow_station, by = "Indicator", station = TRUE, labels = FALSE, dir = "snow_station", ask = FALSE)
